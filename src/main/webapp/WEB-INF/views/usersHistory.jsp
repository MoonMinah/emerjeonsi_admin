...
<html lang="en">
    <head>
        ...
        <title>Users History Table</title>
...
<%--                            </a>--%>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">서비스 회원 이력</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="/admin/home">대시보드</a></li>
                            <li class="breadcrumb-item active">서비스 회원 이력</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body table-responsive-xxl">
                                <table class="table table-bordered table-striped table-hover" style="text-align: center">
                                    <thead>
                                    <tr>
                                        <th scope="col">회원 이력 번호</th>
                                        <th scope="col">회원 번호</th>
                                        <th scope="col">회원 아이디</th>
                                        <th scope="col">회원 상태</th>
                                        <th scope="col">회원 상태 변경일시</th>
                                        <th scope="col">회원 정보 보관 기한</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <!-- 데이터는 js로 채워지게 한다. -->
        ...
        <script src="/admin/js/usersHistory.js"></script>
    </body>
</html>
